...
type CreateAccountBalance struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	NewBalance string `protobuf:"bytes,3,opt,name=newBalance,proto3" json:"newBalance,omitempty"`
}

func (x *CreateAccountBalance) Reset() {
	*x = CreateAccountBalance{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateAccountBalance) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateAccountBalance) ProtoMessage() {}

func (x *CreateAccountBalance) ProtoReflect() protoreflect.Message {
	mi := &file_structure_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateAccountBalance.ProtoReflect.Descriptor instead.
func (*CreateAccountBalance) Descriptor() ([]byte, []int) {
	return file_structure_proto_rawDescGZIP(), []int{1}
}

func (x *CreateAccountBalance) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *CreateAccountBalance) GetSymbol() string {
	if x != nil {
		return x.Symbol
	}
	return ""
...
func (x *CreateAccountBalance) GetNewBalance() string {
	if x != nil {
		return x.NewBalance
	}
	return ""
...
var file_structure_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x44, 0x61, 0x74, 0x65, 0x22, 0x66, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x16,
	0x0a, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x12, 0x1e,
	0x0a, 0x0a, 0x6e, 0x65, 0x77, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0a, 0x6e, 0x65, 0x77, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x22, 0x4a,
	...
	0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x2a, 0x42, 0x0a, 0x09, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x14, 0x0a, 0x10, 0x54, 0x59, 0x50, 0x45, 0x5f,
	0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0f, 0x0a,
	0x0b, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4d, 0x41, 0x52, 0x4b, 0x45, 0x54, 0x10, 0x01, 0x12, 0x0e,
	0x0a, 0x0a, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4c, 0x49, 0x4d, 0x49, 0x54, 0x10, 0x02, 0x2a, 0x6d,
	...
	0x4e, 0x45, 0x57, 0x10, 0x01, 0x12, 0x14, 0x0a, 0x10, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f,
	0x50, 0x41, 0x52, 0x54, 0x5f, 0x46, 0x49, 0x4c, 0x4c, 0x10, 0x02, 0x12, 0x0f, 0x0a, 0x0b, 0x53,
	0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x46, 0x49, 0x4c, 0x4c, 0x10, 0x03, 0x12, 0x0f, 0x0a, 0x0b,
	0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x44, 0x4f, 0x4e, 0x45, 0x10, 0x04, 0x2a, 0x4d, 0x0a,
	...
	0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x12, 0x0a, 0x0e, 0x44, 0x49, 0x52, 0x45, 0x43, 0x54, 0x49,
	0x4f, 0x4e, 0x5f, 0x53, 0x45, 0x4c, 0x4c, 0x10, 0x01, 0x12, 0x11, 0x0a, 0x0d, 0x44, 0x49, 0x52,
	0x45, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x42, 0x55, 0x59, 0x10, 0x02, 0x42, 0x0e, 0x5a, 0x0c,
	0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x2f, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_structure_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_structure_proto_goTypes = []interface{}{
	...
	(*CreateAccountBalance)(nil), // 4: protofile.CreateAccountBalance
	(*CreateAccountRequest)(nil), // 5: protofile.CreateAccountRequest
...
var file_structure_proto_depIdxs = []int32{
	...
	6, // 2: protofile.CreateOrderRequest.createDate:type_name -> google.protobuf.Timestamp
...
func file_structure_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_structure_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateAccountBalance); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
